...
public class ControladorSellos {
	...
	public static boolean sellarCarnet(Carnet carnet, boolean estancia) {

		if (CarnetDAO.getCarnetDAO().actualizarCarnet(carnet, estancia))
			return true;
		else
			return false;
	}
	
	public static boolean guardarEstancia(Peregrino peregrino, Usuario user, boolean tipo, LocalDate fecha) {
